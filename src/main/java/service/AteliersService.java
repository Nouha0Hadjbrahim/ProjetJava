...
public class AteliersService {
    ...
    public List<Ateliers> getAllAteliersByArtisan(int artisanId) {
        List<Ateliers> ateliers = new ArrayList<>();
        String sql = "SELECT * FROM atelierenligne WHERE id_user_id = ?";
        ...
        try (PreparedStatement ps = cnx.prepareStatement(sql)) {
            ...
            System.err.println("❌ Erreur getAllAteliersByArtisan: " + e.getMessage());
            e.printStackTrace();
        }
        return ateliers;
    }

    public int getTotalAteliersByArtisan(int artisanId) {
        int total = 0;
        String sql = "SELECT COUNT(*) FROM atelierenligne WHERE id_user_id = ?";
        ...
        try (PreparedStatement ps = cnx.prepareStatement(sql)) {
            ...
            System.err.println("❌ Erreur getTotalAteliersByArtisan: " + e.getMessage());
            e.printStackTrace();
        }
