...
public class BackReclamationController {
    ...
    //filtrage des réclamations selon qu’on affiche les archivées ou non.
    ...
    //basculer entre les réclamations actives et archivées.
    private void configureToggle() {
        if (toggleArchive != null && pagination != null) { // verification
