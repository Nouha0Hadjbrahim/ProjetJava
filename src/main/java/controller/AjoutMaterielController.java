    ...
    public void initialize() {
        try {
            ...
            if (fournisseurs.isEmpty()) {
                System.out.println("Aucun fournisseur trouvé dans la base de données");
            }
            ...
            fournisseurCombo.getItems().addAll(fournisseurs);
    ...
    private void handleAjouter() {
        ...
        try {
            ...
            if (photoField.getText().trim().isEmpty()) {
                showFieldError(photoField, "L'ajout de photo est obligatoire");
                return;
            }
            if (fournisseurCombo.getValue() == null) {
                showComboError(fournisseurCombo, "Veuillez sélectionner un fournisseur");
                return;
            }


            // Si toutes les validations passent
            Material nouveauMateriel = new Material(
                    nomField.getText(),
                    quantite,
                    seuil,
            ...
            nouveauMateriel.setFournisseur(fournisseurCombo.getValue());
            nouveauMateriel.setUser(connectedUser);

            materiauxService.ajouter(nouveauMateriel);
